...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗メニュー情報登録機能.drawio.pdf}
  \caption{メニュー登録機能}
  \label{fig:メニュー登録機能}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗メニュー情報削除機能.drawio.pdf}
  \caption{メニュー削除機能}
  \label{fig:メニュー削除機能}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗メニュー情報変更機能.drawio.pdf}
  \caption{メニュー情報変更機能}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗配達員情報確認機能.drawio.pdf}
  \caption{配達員情報確認機能}
  \label{fig:配達員情報確認機能}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗受け渡し完了確認機能.drawio.pdf}
  \caption{受け渡し完了確認機能}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗配達トラブル報告機能.drawio.pdf}
  \caption{配達トラブル報告機能}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗売上確認機能.drawio.pdf}
  \caption{売上確認機能}
  \label{fig:売上確認機能}
\end{figure}
...
\subsubsection{総利用者数管理}
総利用者数の管理を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/総利用者数管理.pdf}
  \caption{総利用者数管理機能}
  \label{fig:総利用者数管理}
\end{figure}
