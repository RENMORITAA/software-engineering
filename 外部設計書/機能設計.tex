...
\subsubsection{依頼者注文履歴情報詳細表示}
依頼者アカウントの注文履歴の表示を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/依頼者注文履歴情報詳細表示機能.pdf}
  \caption{依頼者注文履歴情報詳細表示機能}
  \label{fig:依頼者注文履歴情報詳細表示機能}
\end{figure}
\clearpage
