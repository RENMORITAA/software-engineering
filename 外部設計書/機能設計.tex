...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗在庫ステータス変更機能a.drawio.pdf}
  \caption{在庫ステータス変更機能}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗受注一覧機能a.drawio.pdf}
  \caption{受注一覧機能}
  \label{fig:受注一覧機能}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗配達員情報確認改a.drawio.pdf}
  \caption{配達員情報確認機能}
  \label{fig:配達員情報確認機能}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗側受け渡し確認機能改a.drawio.pdf}
  \caption{受け渡し完了確認機能}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗側配達トラブル報告機能改a.drawio.pdf}
  \caption{配達トラブル報告機能}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗売上画面a.drawio.pdf}
  \caption{売上確認機能}
  \label{fig:売上確認機能}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗売り上げ数管理機能a.drawio.pdf}
  \caption{売り上げ数確認機能}
  \label{fig:売り上げ数確認機能}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗明細表示機能a.drawio.pdf}
  \caption{明細表示機能}
  \label{fig:明細表示機能}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/配達員詳細機能.pdf}
  \caption{配達員詳細表示機能}
  \label{fig:配達員詳細表示機能}
\end{figure}
\clearpage

\subsubsection{配達員詳細編集}
配達員アカウントの詳細の編集を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/配達員編集機能.pdf}
  \caption{配達員詳細編集機能}
  \label{fig:配達員編集表示機能}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/配達員通知機能.pdf}
  \caption{配達員通知機能}
  \label{fig:配達員通知機能}
\end{figure}
\clearpage

\subsubsection{配達員履歴書表示}
配達員アカウントの履歴書表示を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/配達員履歴書表示機能.pdf}
  \caption{配達員履歴書表示機能}
  \label{fig:配達員履歴書表示機能}
\end{figure}
\clearpage

\subsubsection{配達員配達履歴表示機能}
配達員アカウントの配達履歴の表示を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/配達員配達履歴表示機能.pdf}
  \caption{配達員配達履歴表示機能}
  \label{fig:配達員配達履歴表示機能}
\end{figure}
\clearpage
...
\subsubsection{警告通知送信}
配達員アカウントの詳細画面から警告通知の送信を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/警告通知送信機能.pdf}
  \caption{警告通知送信機能}
  \label{fig:警告通知送信機能}
\end{figure}
\clearpage

\subsubsection{警告通知履歴}
配達員アカウントの詳細画面から警告通知の履歴表示を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/警告通知履歴機能.pdf}
  \caption{警告通知履歴機能}
  \label{fig:警告通知履歴機能}
\end{figure}
\clearpage
...
\subsubsection{店舗アカウント詳細表示}
店舗アカウントの詳細の表示を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/店舗アカウント詳細表示機能.pdf}
  \caption{店舗アカウント詳細表示機能}
  \label{fig:店舗アカウント詳細表示機能}
\end{figure}
\clearpage

\subsubsection{店舗アカウント編集}
店舗アカウントの編集を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/店舗アカウント編集機能.pdf}
  \caption{店舗アカウント編集機能}
  \label{fig:店舗アカウント編集機能}
\end{figure}
\clearpage

\subsubsection{店舗アカウント販売履歴}
店舗アカウントの販売履歴を表示する機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/店舗アカウント販売履歴機能.pdf}
  \caption{店舗アカウント販売履歴表示機能}
  \label{fig:店舗アカウント販売履歴表示機能}
\end{figure}
\clearpage
...
\subsubsection{管理者アカウント編集}
管理者アカウントの編集を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/管理者アカウント編集機能.pdf}
  \caption{管理者アカウント編集機能}
  \label{fig:管理者アカウント編集機能}
\end{figure}
\clearpage

\subsubsection{管理者アカウント管理者権限の編集}
管理者アカウントの管理者権限の編集を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/管理者アカウント管理者権限機能.pdf}
  \caption{管理者アカウント管理者権限の編集}
  \label{fig:管理者アカウント管理者権限の編集}
\end{figure}
\clearpage

\subsubsection{精算管理詳細表示}
管理者アカウントから精算管理の詳細を表示する機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/精算管理詳細機能.pdf}
  \caption{精算管理詳細表示機能}
  \label{fig:精算管理詳細表示機能}
\end{figure}
\clearpage

\subsubsection{精算管理からの店舗画面選択}
管理者アカウントから精算管理から店舗画面に選択する際の機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/精算管理店舗機能.pdf}
  \caption{精算管理からの店舗画面選択機能}
  \label{fig:精算管理からの店舗画面選択機能}
\end{figure}
\clearpage

\subsubsection{精算管理からの配達員画面選択機能}
管理者アカウントから精算管理から配達員画面に選択する際の機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/精算管理配達員機能.pdf}
  \caption{精算管理からの配達員画面選択機能}
  \label{fig:精算管理からの配達員画面選択機能}
\end{figure}
\clearpage

\subsubsection{精算管理からの収益管理選択}
管理者アカウントから精算管理から収益管理画面に選択する際の機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/精算管理収益管理機能.pdf}
  \caption{精算管理からの収益管理画面選択機能}
  \label{fig:精算管理からの収益管理画面選択機能}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/収益管理詳細機能.pdf}
  \caption{収益管理機能}
  \label{fig:収益管理}
\end{figure}
\clearpage

\subsubsection{収益管理から総利用者数画面選択}
収益の管理を総利用者数画面選択を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/収益管理総利用者数機能.pdf}
  \caption{収益管理総利用者数機能}
  \label{fig:収益管理総利用者数機能}
\end{figure}
\clearpage

\subsubsection{収益管理から注文数管理画面選択}
収益の管理を注文数管理画面選択を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/収益管理注文数管理機能.pdf}
  \caption{収益管理注文管理数機能}
  \label{fig:収益管理注文管理数機能}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/総利用者数管理依頼者数管理-圧縮.pdf}
  \caption{依頼者数管理機能}
  \label{fig:依頼者数管理}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/総利用者数管理配達員数管理1-圧縮-圧縮.pdf}
  \caption{配達員数管理機能}
  \label{fig:配達員数管理}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/総利用者数管理新規登録数管理-圧縮.pdf}
  \caption{新規登録数管理機能}
  \label{fig:新規登録数管理}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/総利用者数管理精算管理-圧縮.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/総利用者数管理注文数管理-圧縮.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/注文数管理詳細機能.pdf}
  \caption{注文数管理機能}
  \label{fig:注文数管理}
\end{figure}
\clearpage

\subsubsection{注文数管理から総利用数画面選択}
注文数の管理から総利用者数画面選択を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/注文数管理総利用者数機能.pdf}
  \caption{注文数管理から総利用数画面選択機能}
  \label{fig:注文数管理から総利用者数画面選択}
\end{figure}
\clearpage

\subsubsection{注文数管理から収益管理画面選択}
注文数の管理から収益管理画面選択を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/注文数管理収益管理機能.pdf}
  \caption{注文数管理から収益管理画面選択機能}
  \label{fig:注文数管理から収益管理画面選択}
\end{figure}
\clearpage
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/売り上げ管理詳細機能.pdf}
  \caption{売り上げ管理機能}
  \label{fig:売り上げ管理管理}
\end{figure}
\clearpage

\subsubsection{売り上げ管理から総利用者数画面選択}
売り上げの管理から総利用者数画面の選択を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/売り上げ管理総利用者数機能.pdf}
  \caption{売り上げ管理から総利用者数画面選択機能}
  \label{fig:売り上げ管理管理から総利用者数画面選択}
\end{figure}
\clearpage

\subsubsection{売り上げ管理から注文数画面選択}
売り上げの管理から注文数数画面の選択を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/売り上げ管理注文数機能.pdf}
  \caption{売り上げ管理から注文数画面選択機能}
  \label{fig:売り上げ管理管理から注文数画面選択}
\end{figure}
\clearpage

\subsubsection{売り上げ管理から収益管理画面選択}
売り上げの管理から収益管理画面の選択を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/売り上げ管理収益管理機能.pdf}
  \caption{売り上げ管理から収益管理画面選択機能}
  \label{fig:売り上げ管理管理から収益管理画面選択}
\end{figure}
\clearpage
...
\subsubsection{全体通知通知内容詳細}
全体通知通知内容詳細の表示を行う機能である。
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/administrator機能設計/全体通知内容詳細.pdf}
  \caption{全体通知内容詳細機能}
  \label{fig:全体通知内容詳細}
\end{figure}
\clearpage
