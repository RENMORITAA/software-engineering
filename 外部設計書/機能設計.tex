...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./drawio遷移図/店舗画面遷移図改.pdf}
  \caption{店舗側機能概要図}
  \label{fig:店舗側機能概要図}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/画面遷移図/管理者遷移図_修正版.pdf}
  \caption{管理者側機能概要図}
  \label{fig:管理者側機能概要図}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗メニュー情報登録機能改.drawio.pdf}
  \caption{メニュー登録機能}
  \label{fig:メニュー登録機能}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗メニュー情報削除機能改.drawio.pdf}
  \caption{メニュー削除機能}
  \label{fig:メニュー削除機能}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗メニュー情報編集機能改.drawio.pdf}
  \caption{メニュー情報変更機能}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗受け渡し確認機能改.drawio.pdf}
  \caption{受け渡し完了確認機能}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{./Image/店舗配達トラブル報告機能改.drawio.pdf}
  \caption{配達トラブル報告機能}
