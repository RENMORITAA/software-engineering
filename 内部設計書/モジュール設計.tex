...
& 出力 & なし \\ \cline{2-3}
&\multicolumn{2}{l|}{他クラスとの関係} \\\cline{2-3}
&\multicolumn{2}{p{0.9\linewidth}|}{root_page.dart を組み込む

c_home.dart を組み込む

c_cart.dart を組み込む

c_map_search.dart を組み込む

d_home.dart を組み込む

d_job_select.dart を組み込む

d_job_map_select.dart を組み込む

d_deliverly_history.dart を組み込む

s_home.dart を組み込む

s_work.dart を組み込む

s_order_list.dart を組み込む

s_sales.dart を組み込む

mypage.dart を組み込む

change_root_page.dart を組み込む

login_page.dart を組み込む

app\_router.gr.dart を組み込む} \\ \hline
\end{tabular}
\end{table}
...
& 出力 & Widget \\ \cline{2-3}
&\multicolumn{2}{l|}{他クラスとの関係} \\\cline{2-3}
&\multicolumn{2}{p{0.9\linewidth}|}{AutoTabsScaffold等を用い、s_home, s_work, s_order_list, s_sales, mypageを子ルートとして管理する} \\ \hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
  \centering
  \safeincludegraphics[width=0.75\textwidth]{状態遷移図/s_root_page.drawio.pdf}
...
& 出力 & Widget \\ \cline{2-3}
&\multicolumn{2}{l|}{他クラスとの関係} \\\cline{2-3}
&\multicolumn{2}{p{0.9\linewidth}|}{s_inventory_status.dart、s_menu_edit.dartのリンクを持つ} \\ \hline
\end{tabular}
\end{table}
...
& 出力 & Widget \\ \cline{2-3}
&\multicolumn{2}{l|}{他クラスとの関係} \\\cline{2-3}
&\multicolumn{2}{p{0.9\linewidth}|}{追加！！！！！！} \\ \hline
\end{tabular}
\end{table}
...
& 出力 & Widget \\ \cline{2-3}
&\multicolumn{2}{l|}{他クラスとの関係} \\\cline{2-3}
&\multicolumn{2}{p{0.9\linewidth}|}{s_menu_regist.dart, s_menu_change.dart, s_menu_delete.dart の機能を包含または遷移する} \\ \hline
\end{tabular}
\end{table}
...
& 出力 & Widget \\ \cline{2-3}
&\multicolumn{2}{l|}{他クラスとの関係} \\\cline{2-3}
&\multicolumn{2}{p{0.9\linewidth}|}{登録完了後、finish_screen.dart を表示し、s_menu_edit.dart に戻る。} \\ \hline
\end{tabular}
\end{table}
...
& 出力 & Widget \\ \cline{2-3}
&\multicolumn{2}{l|}{他クラスとの関係} \\\cline{2-3}
&\multicolumn{2}{p{0.9\linewidth}|}{confirm_inf_change.dart を呼び出して変更の最終確認を行う。} \\ \hline
\end{tabular}
\end{table}
...
& 出力 & Widget \\ \cline{2-3}
&\multicolumn{2}{l|}{他クラスとの関係} \\\cline{2-3}
&\multicolumn{2}{p{0.9\linewidth}|}{確定後、finish_screen.dart を表示する。} \\ \hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
  ...
  \caption{s_delivery_complete.dart の状態遷移図}
