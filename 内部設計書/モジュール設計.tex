...
\begin{figure}[H]
  \centering
  \safeincludegraphics[width=0.75\textwidth]{状態遷移図/common_状態遷移図/ConfirmInfChange.pdf}
...
\begin{figure}[H]
  ...
  \safeincludegraphics[width=0.75\textwidth]{状態遷移図/common_状態遷移図/RuleScreen.pdf}
  \caption{rule\_screen.dart の状態遷移図}
  \label{fig:rule_screen_signedin.dart}
\end{figure}


\begin{figure}[H]
  \centering
  \safeincludegraphics[width=0.5\textwidth]{./状態遷移図/delivery_状態遷移図/Notice_detail.pdf}
...
\IfFileExists{状態遷移図/common_状態遷移図/LoginPage.pdf}{%
  \begin{figure}[H]
    \centering
    \safeincludegraphics[width=0.75\textwidth]{状態遷移図/common_状態遷移図/LoginPage.pdf}
